...
branch_strategy: Lane worktree under .worktrees/<slug>-<mid8>-lane-<id>/, branched from planning_base_branch (after WP03 merges), merging back to merge_target_branch.
subtasks:
- T017
- T018
- T019
