...
branch_strategy: WP01 executes in its own lane worktree branched from feature/post-review-remediation-and-demo-deploy. Merge back into that branch on approval.
subtasks:
- T001
- T002
- T003
